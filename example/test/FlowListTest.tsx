...
export default class extends React.Component {
  ...
  private URL =
    'https://api-mo.lajsf.com/gateway/search/v2.0/pb/nutrition-search/action/searchDiet';

  //　请求的方法
  private request = (body: {}) => {
    return fetch(
      `${this.URL}?pageNo=${body.pageNo}&pageSize=${body.pageSize}&keyword=菜`,
      {
        method: 'GET',
        headers: {
  ...
  renderGetRefDemo = () => {
    return <Button onPress={() => this.getFlowRef()} title="get ref"></Button>;
  };
