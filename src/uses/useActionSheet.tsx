...
import ActionSheetContainer, { ActionSheetOptions } from 'components/action-sheet/ActionSheetContainer'

export const useActionSheet = () => {
  const overlay = useOverlay()
  const show = (options: ActionSheetIOSOptions & ActionSheetOptions): Promise<number> => {
    ...
    //   })
    return overlay.show(overlayProps => <ActionSheetContainer {...options} {...overlayProps} />, {
      popupType: 'slide-up',
