...
export const useOverlay = () => {
  ...
  const overlay = useMemo(() => {
    const show = (Component: TopViewComponent, overlayProps?: Omit<OverlayProps, 'ChildComponent' | 'onDismiss'>) => {
      return topViewRef.current.show(props => {
        return <Overlay {...overlayProps} onDismiss={props.onDismiss} ChildComponent={Component} />
      })
    }
    return { show }
  }, [])
